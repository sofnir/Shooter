...
void AShooterCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty> & OutLifetimeProps) const
{
	...
	DOREPLIFETIME(AShooterCharacter, Task);
}
...
void AShooterCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AShooterCharacter::StartFiring);
...
void AShooterCharacter::PerformTask(ETaskEnum::Type NewTask)
{
...
void AShooterCharacter::ServerPerformTask_Implementation(ETaskEnum::Type NewTask)
{
	PerformTask(NewTask);
}

bool AShooterCharacter::ServerPerformTask_Validate(ETaskEnum::Type NewTask)
{
	return true;
}
...
void AShooterCharacter::OnFire()
{
	...
	GetWorldTimerManager().SetTimer(TimerHandle_Task, this, &AShooterCharacter::OnFire, 1.f);
}
...
void AShooterCharacter::OnRep_Task()
{
	switch (Task)
	{
	case(ETaskEnum::None) : 
