...
{
	// If ptojectile hits destructible box do nothing becouse in the destructible box is collision implementation    
	if (OtherActor->IsA(ADestructibleBox::StaticClass()))
	{
		return;
	}
